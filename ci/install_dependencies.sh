...
case "$distro_id" in
    ...
    'debian')
        apt-get update
        apt-get install -y cmake g++ clang make ccache python3 libexpat1-dev zlib1g-dev libssh-dev libcurl4-openssl-dev libgtest-dev libxml2-utils locales locales-all
        debian_build_gtest
        ;;
